<div class="bg-content">
    ...
    <div class='parent'>
      <div class='slider'>
        ...
        <div id='slide1' class='slide1 up1'>
          <span>Người trái đất với những kỹ năng đặc biệt khó chịu, và rất mạnh khi đi theo nhóm. Đại diện Gohan, Krillin, Yamcha</span>
        </div>
        <div id='slide2' class='slide2'>
          <span>Khả năng tái tạo và hỗ trợ đồng đội đáng kinh ngạc của người Namếc, với đại diện Ốc tiêu, Pocollo và Kami.</span>
        </div>
        <div id='slide3' class='slide3'>
          <span>Trải nghiệm sức mạnh kinh hoàng khi chiến đấu đơn độc của các chiến binh Xayda với sự đại diện của Cađic, Rađic và Kakalot.</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <p style="text-align:center"><strong><img alt="" src="/assets/images/screen/9-3.png" /></strong></p>
  ...
  <div class='text-center'>
    ...
    <a id='slider-14.8' onclick="slider14(8)" href="javascript::void(0)" class='carousel-2'>8</a>
  </div>
  <br />
  <br />
</div>
